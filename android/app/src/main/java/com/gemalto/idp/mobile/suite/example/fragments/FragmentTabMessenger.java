...
import com.gemalto.idp.mobile.suite.MobileFingerprintSource;
import com.gemalto.idp.mobile.suite.MobileSuite;
import com.gemalto.idp.mobile.suite.MobileSuiteException;
import com.gemalto.idp.mobile.suite.MobileTlsConfiguration;
import com.gemalto.idp.mobile.suite.example.MessengerConfigurations;
import com.gemalto.idp.mobile.suite.example.R;
import com.gemalto.idp.mobile.suite.example.Utils;
import com.gemalto.idp.mobile.suite.messenger.MobileMessageManager;
import com.gemalto.idp.mobile.suite.messenger.MobileMessenger;
import com.gemalto.idp.mobile.suite.messenger.callback.AcknowledgeCallback;
import com.gemalto.idp.mobile.suite.messenger.callback.FetchMessageCallback;
import com.gemalto.idp.mobile.suite.messenger.callback.FetchResponse;
import com.gemalto.idp.mobile.suite.messenger.callback.MobileMessengerCallback;
import com.gemalto.idp.mobile.suite.messenger.callback.RegistrationCallback;
import com.gemalto.idp.mobile.suite.messenger.callback.RegistrationResponse;
import com.gemalto.idp.mobile.suite.messenger.callback.SendMessageCallback;
import com.gemalto.idp.mobile.suite.messenger.callback.SendResponse;
import com.gemalto.idp.mobile.suite.messenger.message.OutgoingMessage;
import com.gemalto.idp.mobile.suite.messenger.message.TransactionSigningRequest;
import com.gemalto.idp.mobile.suite.messenger.message.TransactionSigningResponse;
import com.gemalto.idp.mobile.suite.messenger.message.TransactionVerifyRequest;
import com.gemalto.idp.mobile.suite.messenger.message.TransactionVerifyResponse;
...
public class FragmentTabMessenger extends Fragment {
    ...
    private MobileSuite mobileSuite;
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater,
        ...
        // Retrieved Mobile Suite instance that was configured on the Application startup
        mobileSuite = MobileSuite.getInstance();
    ...
    private void initializeMobileMessenger() {
        ...
        mobileMessenger = mobileSuite.getMobileMessengerBuilder(MessengerConfigurations.getMessengerServerUrl(),
    ...
    private void registration() {
        ...
        mobileMessenger.register(MessengerConfigurations.getUserId(),
                ...
                new RegistrationCallback() {
                    @Override
                    public void onRegistrationResponse(RegistrationResponse registrationResponse) {
    ...
    private void fetchMessage() {
        ...
        messageManager.fetchMessage(30, null, new FetchMessageCallback() {
            @Override
            public void onFetchResponse(FetchResponse fetchResponse) {
                ...
                if(fetchResponse.hasIncomingMessage()) {
                    ...
                    showMessageDialog(fetchResponse).show();
                } else {
        ...
        try {
            ...
            switch (value) {
                ...
                case ACCEPTED:
                    ...
                    OathMobileProtector protector = mobileSuite.getOathMobileProtectorInstance();
                    ...
                    if(protector.getTokenDeviceNames().isEmpty()) {
                        ...
                        // Get token device using the name
                        String tokenDeviceName = protector.getTokenDeviceNames().iterator().next();
                        OathTokenDevice tokenDevice = protector.getTokenDevice(tokenDeviceName, null);
                        String serverChallenge = null;
                        try {
                            serverChallenge = new String(request.getOcraServerChallenge(), "UTF-8");
     ...
     */
    private AlertDialog showMessageDialog(FetchResponse response) {
        ...
        // Finally, create the alert dialog
